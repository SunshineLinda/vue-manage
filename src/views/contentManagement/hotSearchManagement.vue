<template>
	<section>
		...
		<!--<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">-->
			<p style	="font-size：12px;color:gray;">注:关键词最多不能超过十个</p>
		<!--</el-col>-->
		<!--列表-->
		<el-table :data="users" border highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="sex" label="关键词" width="100">
			</el-table-column>
		...
		<el-col :span="24" class="toolbar">
			<el-button type="danger" @click="batchRemove" :disabled="this.sels.length===0">禁用</el-button>
