<template>
	<section>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="name" label="频道默认排序" sortable>
			</el-table-column>
			<el-table-column prop="sex" label="频道名称">
			</el-table-column>
			...
			<el-table-column label="操作" width="400">
				<template slot-scope="scope">
					...
					<el-button type="danger" size="small" @click="handleDel(scope.$index, scope.row)">焦点图管理</el-button>
				</template>
			</el-table-column>
		</el-table>
