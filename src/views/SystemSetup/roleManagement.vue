<template>
	<section>
		...
		<el-table :data="users" border highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="sex" label="角色描述">
			</el-table-column>
			...
			<el-table-column label="操作" width="400">
				<template slot-scope="scope">
					...
					<el-button size="small" >是否禁用</el-button>
					<el-button size="small" @click="handLimit(scope.$index,scope.row)">权限设置</el-button>
				</template>
			</el-table-column>
		</el-table>
		...
		<el-dialog title="编辑" v-model="editFormVisible" :visible.sync="editFormVisible":close-on-click-modal="false">
			<el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				...
				<el-form-item label="角色描述" prop="addr">
		...
		<!--权限设置-->
		<el-dialog title="权限设置" v-model="limitFormVisible" :visible.sync="limitFormVisible" :close-on-click-modal="false">
			<el-form :model="limitForm" label-width="80px" :rules="limitRules" ref="limitForm">
				<el-tree
				  :data="data2"
				  show-checkbox
				  default-expand-all
